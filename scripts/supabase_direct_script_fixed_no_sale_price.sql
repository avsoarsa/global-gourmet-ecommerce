...
-- It will create the exec_sql function, check for the junction table,
-- and add categories and products
...
-- Step 2: Check if product_categories_junction table exists and create it if needed
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    CREATE POLICY "Allow service role full access" ON product_categories_junction 
    FOR ALL 
    USING (auth.role() = 'service_role');
    
    -- Allow authenticated users full access (simplified for now)
    CREATE POLICY "Allow authenticated users full access" ON product_categories_junction 
    FOR ALL 
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-quinoa') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-brown-rice') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-rolled-oats') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-broccoli-sprouts') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'fresh-alfalfa-sprouts') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mung-bean-sprouts') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-chia-seeds') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-spirulina-powder') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'dried-goji-berries') THEN
    INSERT INTO products (
      id, name, slug, description, short_description, price,
      stock_quantity, sku, weight, dimensions, is_active, is_featured, 
      created_at, updated_at
