-- Migrate basic product and category data (simplified version)
...
-- Now, let's add some sample products (without using discount_percentage)
INSERT INTO products (id, name, slug, description, short_description, price, compare_at_price, origin, stock_quantity, is_featured, is_bestseller, is_organic, rating, review_count, category_id)
VALUES
  ('00000000-0000-0000-0000-000000000001', 'Premium Medjool Dates', 'premium-medjool-dates', 'Soft, sweet and delicious Medjool dates sourced from the finest date farms. Rich in fiber and essential nutrients.', 'Premium quality Medjool dates', 12.99, 15.99, 'Jordan', 100, true, true, true, 4.8, 124, '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0000-000000000002', 'Organic Almonds', 'organic-almonds', 'Premium quality organic almonds. Perfect for snacking or adding to your favorite recipes.', 'Premium quality organic almonds', 14.99, 17.99, 'California', 100, true, true, true, 4.7, 98, '00000000-0000-0000-0000-000000000004'),
  ('00000000-0000-0000-0000-000000000003', 'Raw Cashews', 'raw-cashews', 'Creamy and delicious raw cashews. A versatile nut that''s perfect for snacking, cooking, or making homemade cashew milk.', 'Premium quality raw cashews', 16.99, 19.99, 'Vietnam', 100, false, true, false, 4.6, 87, '00000000-0000-0000-0000-000000000004'),
  ('00000000-0000-0000-0000-000000000004', 'Dried Apricots', 'dried-apricots', 'Sweet and tangy dried apricots. A delicious snack packed with vitamins and minerals.', 'Sweet and tangy dried apricots', 9.99, 11.99, 'Turkey', 100, false, false, true, 4.5, 76, '00000000-0000-0000-0000-000000000003'),
  ('00000000-0000-0000-0000-000000000005', 'Kashmiri Saffron', 'kashmiri-saffron', 'Premium Kashmiri saffron known for its distinct aroma and flavor. A little goes a long way in enhancing your dishes.', 'Premium Kashmiri saffron', 29.99, 34.99, 'India', 50, true, false, true, 4.9, 65, '00000000-0000-0000-0000-000000000005')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
