...
const MobileAddToCartBar = ({
  ...
  return (
    <div className="fixed bottom-16 left-0 right-0 bg-white border-t border-gray-200 p-3 flex items-center justify-between z-50 md:hidden mobile-add-to-cart-bar shadow-lg">
